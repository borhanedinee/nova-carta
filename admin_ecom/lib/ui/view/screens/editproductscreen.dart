...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void initState() {
    ...
    controller.selectedCategorieID = product.categorie;

    controller.selectedCategorieID = product.categorie;
    // controller.selectedColorsIDs = product.colors ;
    // product.sizes = controller.selectedSizesIDs.cast<String>();
                          ...
                          Builder(
                            builder: (context) {
                              return InkWell(
                                onTap: () {
                                  // pick an image
                                  showPickImageOptionsEditScreen(
                                      context, controller);
                                },
                                child: SizedBox(
                                  height: 200,
                          ...
                          CustomButton(
                              onPressed: () async {
                                ...
                                if (controller.file != null) {
                                  product.asset = controller.file!.path;
                                }
                                product.categorie =
                                    controller.selectedCategorieID;
                                product.type = controller.selectedTypeID;
                                // product.colors =
                                //     controller.selectedColorsIDs.cast<String>();
                                // product.sizes =
                                //     controller.selectedSizesIDs.cast<String>();
  ...
  Future<void> editProduct(
    ...
    if (formKey.currentState!.validate()) {
      ...
      // type
      controller.selectedTypeID == 0 || controller.selectedSizesIDs.isEmpty
